...
#define AbbScrollbar_Height(info)      ((info)->abbsb_height)
...
extern Graphics_info *olgx_main_initialize(Display *dpy, int screen,
...
extern Graphics_info *olgx_initialize(Display *dpy, int screen, int d_flag,
    ...
    unsigned long *pixvals, Pixmap *stipple_pixmaps);
extern void olgx_calculate_3Dcolors(XColor *fg, XColor *bg1, XColor *bg2, XColor *bg3, XColor *white);
extern unsigned long olgx_get_single_color(Graphics_info *info, int index);
extern void          olgx_closedown(void);
extern void olgx_destroy(Graphics_info *info);
...
extern void olgx_set_single_color(Graphics_info *info, int index,
    unsigned long pixval, int flag);
extern void olgx_stipple_rect(Graphics_info  *info, Window win,
						int x, int y, int width, int height);
extern void olgx_scroll_stipple_rects(Graphics_info *info, Window win,
    							XRectangle *rects, int numrects);
extern void olgx_draw_accel_button(Graphics_info *info, Window win, int x, int y,
...
extern void olgx_draw_accel_choice_item(Graphics_info *info, Window win, int x, int y,
						int width, int height, void *main_label, int m_pos,
						void *qualifier_label, int	q_pos, int	mark_type,
						int	mark_pos, void *key_label, int	key_pos,
						void *background_pixmap, int state);
extern void olgx_draw_accel_label(Graphics_info *info, Window win, int x, int y,
						int width, int height, void *main_label, int m_pos,
						void *qualifier_label, int	q_pos, int	mark_type,
						int	mark_pos, void *key_label, int	key_pos,
						void *background_pixmap, int state);
extern void olgx_draw_choice_item(Graphics_info *info, Window win,
			int x, int y, int width, int height, void *label, int state);
extern void olgx_draw_scrollbar(Graphics_info  *ginfo, Window win, int x, int y,
    int length, int elev_pos, int old_elev_pos,
    int prop_pos, int prop_length, int state);
extern void olgx_draw_menu_mark(Graphics_info *info, Window win, int x, int y,
							int state, int fill_in);
extern void olgx_draw_abbrev_button( Graphics_info  *info, Window win,
    				int x, int y, int state);
extern void olgx_draw_slider(Graphics_info  *info, Window win,
    		int x, int y, int width, int oldval, int newval, int state);
extern void olgx_draw_horizontal_slider(Graphics_info  *info, Window win,
    				int x, int y, int width, int value, int state);
extern void olgx_draw_vertical_slider(Graphics_info  *info, Window win,
    int x, int y, int height, int value, int state);
extern void olgx_draw_resize_corner(Graphics_info *info, Window win,
    						int x, int y, int type, int state);
extern void olgx_draw_textscroll_button(Graphics_info  *info, Window win, int x, int y, int state);
extern void olgx_draw_numscroll_button(Graphics_info  *info, Window win, int x, int y, int state);
extern void olgx_draw_gauge(Graphics_info *info, Window win, int x, int y,
				int width, int oldval, int newval, int state);
extern void olgx_draw_horiz_gauge(Graphics_info *info, Window win,
    						int x, int y, int width, int value);
extern void olgx_draw_vertical_gauge(Graphics_info *info, Window win, int x,
							int y, int width, int value);

extern void olgx_draw_pushpin(Graphics_info  *info, Window win, int x, int y, int type);
extern void olgx_draw_box(Graphics_info *info, Window win, int x, int y,
				int width, int height, int state, Bool fill_in);
...
extern void olgx_draw_text_ledge(Graphics_info *info, Window win,
    							int x, int y, int width);
extern void olgx_draw_check_box(Graphics_info *info, Window win, int x, int y, int state);

void olgx_draw_drop_target(Graphics_info *info, Window win, void *label, int x, int y, int state);
extern void olgx_draw_button(Graphics_info *info, Window win, int x, int y,
