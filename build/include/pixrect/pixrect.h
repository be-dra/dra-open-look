 ...
 */
struct pixrectops {
	int	(*pro_rop)(Pixrect *, int, int, int, int, int, Pixrect *, int, int);
#ifndef KERNEL
	int	(*pro_stencil)(void *, int, int, int, int, int, Pixrect *,
					int, int, Pixrect *, int, int);
	int	(*pro_batchrop)(void);
	int	(*pro_nop)(void);		/* place holder */
	int	(*pro_destroy)(Pixrect *);
	int	(*pro_get)(void);
	int	(*pro_put)(void);
	int	(*pro_vector)(void);
	Pixrect * (*pro_region)(void);
#endif /* !KERNEL */
	int	(*pro_putcolormap)(void);
#ifndef KERNEL
	int	(*pro_getcolormap)(void);
#endif /* !KERNEL */
	int	(*pro_putattributes)(void);
#ifndef KERNEL
	int	(*pro_getattributes)(void);
#endif /* !KERNEL */
#ifdef KERNEL
	int	(*pro_nop)(void);		/* place holder */
#endif /* KERNEL */
...
extern pr_rop(void);
extern pr_stencil(void);
extern pr_batchrop(void);
extern pr_destroy(void);
extern pr_get(void);
extern pr_put(void);
extern pr_vector(void);
extern Pixrect *pr_region(void);
extern pr_putcolormap(void);
extern pr_getcolormap(void);
extern pr_putattributes(void);
extern pr_getattributes(void);
...
extern prs_rop(void);
extern prs_stencil(void);
extern prs_batchrop(void);
extern prs_destroy(void);
extern prs_get(void);
extern prs_put(void);
extern prs_vector(void);
extern Pixrect *prs_region(void);
extern prs_putcolormap(void);
extern prs_getcolormap(void);
extern prs_putattributes(void);
extern prs_getattributes(void);

extern prs_replrop(void);
extern pr_close(void);
extern pr_line(void);
