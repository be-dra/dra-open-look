...
short	*_mprs_addr(int DASWEISSICHNICHT);
u_char	*_mprs8_addr(int DASWEISSICHNICHT);
int	_mprs_skew(int DASWEISSICHNICHT);
#endif
...
int	mem_rop(int DASWEISSICHNICHT);
#ifndef KERNEL
int	mem_stencil(int DASWEISSICHNICHT);
int	mem_batchrop(int DASWEISSICHNICHT);
Pixrect *mem_create(int DASWEISSICHNICHT);		/* General mpr create routine */
Pixrect *mem_point(int DASWEISSICHNICHT);		/* Even more general mpr create */
int	mem_destroy(int DASWEISSICHNICHT);
int	mem_get(int DASWEISSICHNICHT);
int	mem_put(int DASWEISSICHNICHT);
int	mem_vector(int DASWEISSICHNICHT);
Pixrect *mem_region(int DASWEISSICHNICHT);
#endif /* KERNEL */
int	mem_putcolormap(int DASWEISSICHNICHT);
int	mem_putattributes(int DASWEISSICHNICHT);
#ifndef KERNEL
int	mem_getcolormap(int DASWEISSICHNICHT);
int	mem_getattributes(int DASWEISSICHNICHT);
#endif /* KERNEL */
