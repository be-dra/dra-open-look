...
#define PANEL_SUBWINDOW &xv_panel_subwin_pkg
#define PANEL_ABBREV_WINDOW_BUTTON &xv_panel_awbtn_pkg
 ...
 */
#define PANEL_ITEM_X_START 4 /* offset from left edge */ /* unused in XV4.0 */
#define PANEL_ITEM_Y_START 4 /* offset from top edge */  /* unused in XV4.0 */
...
#define PANEL_ATTR_LIST(ltype, type, ordinal) \
	PANEL_ATTR(ATTR_LIST_INLINE((ltype), (type)), (ordinal))
...
typedef Panel_item Panel_subwin_item;
typedef Panel_item Panel_abbrev_window_item;

/*
 * Enumerations
 */

/* unused at 2021-01-23:  89 91 101 103 104 120 121 and more */
typedef enum {
	/*********************
	 * Public Attributes
	 *********************/
	...
	PANEL_DO_LAYOUT	 = PANEL_ATTR(ATTR_NO_VALUE, 231),	 /* DRA, -S- */
	PANEL_ALIGN_LABELS  = PANEL_ATTR(ATTR_OPAQUE, 86),		/* DRA, -S- */
	PANEL_BUTTONS_TO_MENU = PANEL_ATTR(ATTR_NO_VALUE, 87),	/* DRA, -S- */
	...
	PANEL_ITEM_LAYOUT_ROLE = PANEL_ATTR(ATTR_ENUM, 230),	/* DRA, C-G */
	PANEL_ITEM_LAYOUT_PROC = PANEL_ATTR(ATTR_FUNCTION_PTR, 233), /* DRA, CSG */
	...
	PANEL_CHOICE_FONTS	= PANEL_ATTR_LIST(ATTR_NULL, ATTR_PIXFONT_PTR, 14),
	PANEL_CHOICE_IMAGE	= PANEL_ATTR(PANEL_INDEX_PIXRECT_PTR, 	  16),
	PANEL_CHOICE_IMAGES	= PANEL_ATTR_LIST(ATTR_NULL, ATTR_PIXRECT_PTR, 18),
	...
	PANEL_CHOICE_STRINGS = PANEL_ATTR_LIST(ATTR_NULL, ATTR_STRING,	  22),
	...
	PANEL_ITEM_CYCLIC	= PANEL_ATTR(ATTR_BOOLEAN,		 169),
	PANEL_FEEDBACK		= PANEL_ATTR(ATTR_ENUM,			  50),
	PANEL_MARK_IMAGE	= PANEL_ATTR(PANEL_INDEX_PIXRECT_PTR,	 124),
	PANEL_MARK_IMAGES	= PANEL_ATTR_LIST(ATTR_NULL, ATTR_PIXRECT_PTR,126),
	...
	PANEL_NOMARK_IMAGES	= PANEL_ATTR_LIST(ATTR_NULL, ATTR_PIXRECT_PTR,150),
	 ...
	 * attributes.
	 */
	/* ORIG: PANEL_VALUE		= PANEL_ATTR(ATTR_INT, 			 180), */
	...
	PANEL_LIST_CLIENT_DATAS	= PANEL_ATTR_LIST(ATTR_NULL, ATTR_OPAQUE,  90),
	...
	PANEL_LIST_FONTS	= PANEL_ATTR_LIST(ATTR_NULL, ATTR_PIXFONT_PTR, 98),
	PANEL_LIST_GLYPH	= PANEL_ATTR(PANEL_INDEX_PIXRECT_PTR,	 100),
	PANEL_LIST_GLYPHS	= PANEL_ATTR_LIST(ATTR_NULL, ATTR_PIXRECT_PTR,102),
	...
	PANEL_LIST_STRINGS	= PANEL_ATTR_LIST(ATTR_NULL, ATTR_STRING, 116),
	...
	PANEL_LIST_EXTENSION_DATAS = PANEL_ATTR_LIST(ATTR_NULL, ATTR_OPAQUE, 213),

	PANEL_LIST_MASK_GLYPH	= PANEL_ATTR(PANEL_INDEX_PIXRECT_PTR,	 216),
	PANEL_LIST_MASK_GLYPHS	= PANEL_ATTR_LIST(ATTR_NULL, ATTR_PIXRECT_PTR,217),
	PANEL_LIST_SHOW_PROPS	= PANEL_ATTR(ATTR_BOOLEAN,	99), /* C-- DRA */
	...
	PANEL_KEEP_FULL_MENU = PANEL_ATTR(ATTR_INT,       187), /* DRA: C-- */
	...
	PANEL_WINDOW_ATTRS = PANEL_ATTR_LIST(ATTR_RECURSIVE,ATTR_AV,222), /* CS- */
	PANEL_WINDOW_SIZE_CHANGED = PANEL_ATTR(ATTR_NO_VALUE, 223),       /* -S- */
	PANEL_WINDOW_WIDTH = PANEL_ATTR(ATTR_INT, 224),                   /* CSG */
	PANEL_WINDOW_HEIGHT = PANEL_ATTR(ATTR_INT, 225),                  /* CSG */

	/* Panel_abbrev_window_item attributes */
	PANEL_AWB_WINDOW             = PANEL_ATTR(ATTR_OPAQUE, 226),      /* CSG */
	PANEL_AWB_CREATE_WINDOW_PROC = PANEL_ATTR(ATTR_FUNCTION_PTR, 227),/* CSG */
...
typedef enum {
    ...
    , PANEL_LIST_OP_PROPS    /* DRA */
    , PANEL_LIST_OP_DUPLICATE    /* DRA */
} Panel_list_op;
...
typedef struct panel_ops {
   void (*panel_op_handle_event)(Panel_item, Event *);
   void (*panel_op_begin_preview)(Panel_item, Event *);
   void (*panel_op_update_preview)(Panel_item, Event *);
   void (*panel_op_cancel_preview)(Panel_item, Event *);
   void (*panel_op_accept_preview)(Panel_item, Event *);
   void (*panel_op_accept_menu)(Panel_item, Event *);
   void (*panel_op_accept_key)(Panel_item, Event *);
   void	(*panel_op_clear)(Panel_item);
   void (*panel_op_paint)(Panel_item, Panel_setting);
   void	(*panel_op_resize)(Panel_item);
   void (*panel_op_remove)(Panel_item);
   void (*panel_op_restore)(Panel_item, Panel_setting);
   void (*panel_op_layout)(Panel_item, Rect *deltas);
   void (*panel_op_accept_kbd_focus)(Panel_item);
   void (*panel_op_yield_kbd_focus)(Panel_item);
...
EXTERN_FUNCTION (Panel_attribute_value panel_get, (Panel panel, Panel_attr attr, DOTDOTDOT)) _X_SENTINEL(0);
EXTERN_FUNCTION (int panel_set, (Panel panel, DOTDOTDOT)) _X_SENTINEL(0);
