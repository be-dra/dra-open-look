char p_image_sccsid[] = "@(#)p_image.c 20.18 89/07/31 DRA: $Id: p_image.c,v 4.3 2025/04/03 06:24:44 dra Exp $";
    ...
    Xv_Font         font;
{
    ...
    where.pr = (Pixrect *) xv_create(XV_NULL, SERVER_IMAGE,
				     XV_WIDTH, width,
				     XV_HEIGHT, size.y,
				     SERVER_IMAGE_DEPTH, 1,
					 NULL);
    if (!where.pr) return (NULL);
