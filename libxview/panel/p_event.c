#ifndef lint
#ifdef sccs
static char     sccsid[] = "@(#)p_event.c 20.62 93/06/28 DRA: $Id: p_event.c,v 4.2 2025/01/31 19:45:42 dra Exp $";
#endif
#endif
...
Pkg_private Notify_value panel_notify_event(Xv_Window paint_window,
				Event *event, Notify_arg arg, Notify_event_type type)
{
	Panel_info *panel = (Panel_info *) xv_get(paint_window,
		...
		case ACTION_WHEEL_FORWARD:
			{
				...
				Scrollbar sb = xv_get(pan, OPENWIN_VERTICAL_SCROLLBAR, view);
