#ifndef lint
#ifdef sccs
static char     sccsid[] = "@(#)sel_compat.c 1.23 93/06/28 DRA: $Id: sel_compat.c,v 4.1 2024/03/28 18:30:35 dra Exp $";
#endif
#endif
...
Xv_public char *seln_create(void (*function_proc) (Xv_opaque, Seln_function_buffer *), Seln_result (*request_proc)( Seln_attribute, Seln_replier_data *, int), char *client_data)
{
