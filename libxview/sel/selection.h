/* @(#)selection.h 20.18 93/06/28 SMI	 DRA: $Id: selection.h,v 4.1 2024/03/28 18:30:35 dra Exp $ */
 ...
 */
_XVFUNCPROTOBEGIN
EXTERN_FUNCTION (void	selection_set, (struct selection *sel, int (*sel_write)(struct selection *, FILE *), int (*sel_clear)(void), Xv_opaque window));
/*
 * Fetch the selection
 */
EXTERN_FUNCTION (void 	selection_get, (int (*sel_read)(struct selection *, FILE *), Xv_opaque window));
