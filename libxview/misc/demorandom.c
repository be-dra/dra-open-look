#ifndef lint
#ifdef sccs
static char     sccsid[] = "@(#)demorandom.c 20.15 93/06/28 SMI DRA: RCS $Id: demorandom.c,v 4.1 2024/03/28 18:05:27 dra Exp $ ";	/* from Lucasfilm Ltd.,
							 * 1982 */
#endif
#endif
