#ifndef lint
#ifdef sccs
static char sccsid[] = "@(#)wckind.c 1.793/06/28 Copyr 1992 SMI DRA: RCS $Id: wckind.c,v 2.3 2025/03/15 21:02:14 dra Exp $ ";
#endif
#endif
...
#ifdef linux
/* didn't find "iswascii" anywhere, but I found this: */
static int iswascii(wchar_t c)
{
	return ((unsigned)c < 0x80);
}

/* sorry, I have not understood what wcsetno does - and I haven't found it */
static int wcsetno(wchar_t c)
{
	return 0;
}
#endif /* linux */
