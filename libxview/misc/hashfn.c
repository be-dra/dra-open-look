...
#ifndef lint
#ifdef sccs
static char     sccsid[] = "@(#)hashfn.c 20.12 93/06/28 DRA: RCS $Id: hashfn.c,v 4.2 2024/09/15 09:03:54 dra Exp $ ";
#endif
#endif
 ...
 */
HashTable *hashfn_new_table(int size, int (*hash_fn)(caddr_t),
...
hashfn_lookup(HashTable *h, caddr_t key)
{
 ...
 */
caddr_t				/* payload pointer */
hashfn_install(HashTable *h, caddr_t key, caddr_t payload)
{
    HashEntry      *e;
 ...
 */
caddr_t				/* payload pointer */
hashfn_delete(HashTable *h, caddr_t key)
{
    caddr_t         p;
    HashEntry      *f;
 ...
 */
caddr_t				/* key pointer */
hashfn_first_key(HashTable *h, caddr_t *payload)
{
 ...
 */
caddr_t				/* key pointer */
hashfn_next_key(HashTable *h, caddr_t *payload)
{
