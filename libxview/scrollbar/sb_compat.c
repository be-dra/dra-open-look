#ifndef lint
#ifdef sccs
static char     sccsid[] = "@(#)sb_compat.c 1.19 91/03/19 DRA: $Id: sb_compat.c,v 4.1 2024/03/28 19:47:43 dra Exp $ ";
#endif
#endif
...
#endif
{
    ...
    return (Scrollbar) xv_create(XV_NULL, SCROLLBAR, ATTR_LIST, avlist, NULL);
}
...
{
    return xv_get(sb_public, (Attr32_attribute)attr);
}
