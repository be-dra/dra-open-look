...
#define ACTION_SPLIT_DESTROY_PREVIEW_BEGIN (SCROLLBAR_FIRST+1)
#define ACTION_SPLIT_DESTROY_PREVIEW_CANCEL (SCROLLBAR_FIRST+2)
...
_XVFUNCPROTOBEGIN
EXTERN_FUNCTION (void scrollbar_default_compute_scroll_proc, (Scrollbar sb,
								int pos, int length, Scroll_motion motion,
								long *offset, long *object_length));
 ...
 */
EXTERN_FUNCTION (Scrollbar scrollbar_create, (Attr_attribute attr1, DOTDOTDOT)) _X_SENTINEL(0);
EXTERN_FUNCTION (int scrollbar_set, (Scrollbar sb, DOTDOTDOT)) _X_SENTINEL(0);
