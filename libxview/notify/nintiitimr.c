#ifndef	lint
#ifdef sccs
static char     sccsid[] = "@(#)nintiitimr.c 20.12 93/06/28 Copyr 1985 Sun Micro  DRA: $Id: nintiitimr.c,v 4.1 2024/03/28 18:09:08 dra Exp $ ";
#endif
#endif
...
Notify_error notify_interpose_itimer_func(Notify_client nclient,
