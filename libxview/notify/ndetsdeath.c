#ifndef	lint
#ifdef sccs
static char     sccsid[] = "@(#)ndetsdeath.c 20.12 93/06/28 Copyr 1985 Sun Micro  DRA: $Id: ndetsdeath.c,v 4.1 2024/03/28 18:09:08 dra Exp $ ";
#endif
#endif
...
Notify_destroy_func notify_set_destroy_func(Notify_client nclient, Notify_destroy_func func)
{
    Notify_destroy_func old_func = NOTIFY_DESTROY_FUNC_NULL;
	...
	goto Done;
    /* Exchange functions */
    old_func = (Notify_destroy_func)nint_set_func(condition, (Notify_func)func);
    /* Remove condition if func is null */
    if (func == NOTIFY_DESTROY_FUNC_NULL) {
