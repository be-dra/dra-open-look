#ifndef	lint
#ifdef sccs
static char     sccsid[] = "@(#)ndetpevent.c 20.14 93/06/28 Copyr 1985 Sun Micro DRA: $Id: ndetpevent.c,v 4.1 2024/03/28 18:09:08 dra Exp $ ";
#endif
#endif
...
static Notify_error ndet_p_event(Notify_client nclient, Notify_event event,
    NTFY_TYPE cond_type, Notify_arg arg, Notify_copy copy_func,
    Notify_release release_func, Notify_value *rc);
 ...
 */
Notify_error notify_post_event(Notify_client   nclient,
    Notify_event    event,
...
Notify_error notify_post_event_and_arg(Notify_client nclient,
    Notify_event event, Notify_event_type when_hint,
    Notify_arg arg, Notify_copy copy_func, Notify_release release_func)
{
    NTFY_TYPE       type;
...
pkg_private void
ndet_set_event_processing(Notify_client nclient, int on)
{
    register NTFY_CLIENT *client;
