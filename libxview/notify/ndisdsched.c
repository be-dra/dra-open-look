#ifndef	lint
#ifdef sccs
static char     sccsid[] = "@(#)ndisdsched.c 20.13 93/06/28 Copyr 1985 Sun Micro  DRA: $Id: ndisdsched.c,v 4.1 2024/03/28 18:09:08 dra Exp $ ";
#endif
#endif
...
ndis_default_scheduler(int n, register Notify_client *nclients)
{
