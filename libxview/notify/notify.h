...
/*      @(#)notify.h 20.35 93/06/28 SMI   DRA: $Id: notify.h,v 4.3 2024/11/30 12:42:00 dra Exp $      */
 ...
 */
typedef	Notify_arg (*Notify_copy)(Notify_client, Notify_arg, Notify_event *);

/*
 * A pointer to a function returning void (used for client
 * event additional argument storage releasing).
 */
typedef	void (*Notify_release)(Notify_client, Notify_arg, Notify_event);
...
#else
typedef	Notify_value (*Notify_func)(Notify_client, ...);
#endif
...
typedef Notify_error (*Notify_destroy_func)(Notify_client,Destroy_status);
#define	NOTIFY_DESTROY_FUNC_NULL	((Notify_destroy_func)0)

typedef	Notify_value (*Notify_event_interposer_func)(Notify_client, Notify_event, Notify_arg, Notify_event_type);
#define	NOTIFY_EVINT_FUNC_NULL	((Notify_event_interposer_func)0)

typedef Notify_value (*Notify_signal_func)(Notify_client,int,Notify_signal_mode);
#define	NOTIFY_SIGNAL_FUNC_NULL	((Notify_signal_func)0)

typedef Notify_value (*Notify_timer_func)(Notify_client,int);
#define	NOTIFY_TIMER_FUNC_NULL	((Notify_timer_func)0)

typedef Notify_value (*Notify_io_func)(Notify_client,int);
#define	NOTIFY_IO_FUNC_NULL	((Notify_io_func)0)

typedef Notify_value (*Notify_prioritizer_func)(Notify_client nclient,
						int nfd, fd_set *ibits_ptr,
						...
						Notify_arg *args);
#define	NOTIFY_PRIO_FUNC_NULL	((Notify_prioritizer_func)0)

typedef	Notify_value (*Notify_scheduler_func)(int, Notify_client *);
#define	NOTIFY_SCHED_FUNC_NULL ((Notify_scheduler_func)0)
...
EXTERN_FUNCTION (Notify_destroy_func 	notify_set_destroy_func, (Notify_client nclient, Notify_destroy_func func));
EXTERN_FUNCTION (Notify_io_func 	notify_set_exception_func, (Notify_client nclient, Notify_io_func func, int fd));
EXTERN_FUNCTION (Notify_io_func 	notify_set_input_func, (Notify_client nclient, Notify_io_func func, int fd));
EXTERN_FUNCTION (Notify_timer_func 	notify_set_itimer_func, (Notify_client nclient, Notify_timer_func func, int which, struct itimerval *value, struct itimerval *ovalue));
EXTERN_FUNCTION (Notify_io_func 	notify_set_output_func, (Notify_client nclient,	 Notify_io_func func, int fd));
EXTERN_FUNCTION (Notify_signal_func 	notify_set_signal_func, (Notify_client nclient,	Notify_signal_func func, int sig, Notify_signal_mode mode));
...
EXTERN_FUNCTION (void ndis_set_special_client, (Notify_client nclient));
EXTERN_FUNCTION (void ndis_unset_special_client, (void));
...
EXTERN_FUNCTION (Notify_destroy_func 	notify_get_destroy_func, (Notify_client));
EXTERN_FUNCTION (Notify_func 	notify_get_event_func, (Notify_client nclient, Notify_event_type when));
EXTERN_FUNCTION (Notify_io_func 	notify_get_exception_func, (Notify_client nclient, int fd));
EXTERN_FUNCTION (Notify_io_func	notify_get_input_func, (Notify_client nclient, int fd));
EXTERN_FUNCTION (Notify_timer_func	notify_get_itimer_func,	(Notify_client nclient, int which));
EXTERN_FUNCTION (Notify_io_func 	notify_get_output_func, (Notify_client nclient, int fd));
EXTERN_FUNCTION (Notify_prioritizer_func notify_get_prioritizer_func, (Notify_client nclient));
EXTERN_FUNCTION (Notify_scheduler_func 	notify_get_scheduler_func, (void));
...
EXTERN_FUNCTION (Notify_signal_func notify_get_signal_func, (Notify_client nclient, int signal, Notify_signal_mode mode));
...
EXTERN_FUNCTION (Notify_error	notify_interpose_destroy_func, (Notify_client nclient, Notify_destroy_func func));
EXTERN_FUNCTION (Notify_error 	notify_interpose_event_func, (Notify_client nclient, Notify_event_interposer_func func, Notify_event_type when));
EXTERN_FUNCTION (Notify_error	notify_interpose_exception_func, (Notify_client nclient, Notify_io_func func, int fd));
EXTERN_FUNCTION (Notify_error	notify_interpose_input_func, (Notify_client nclient, Notify_io_func func, int fd));
EXTERN_FUNCTION (Notify_error	notify_interpose_itimer_func, (Notify_client nclient, Notify_timer_func func, int which));
EXTERN_FUNCTION (Notify_error 	notify_interpose_output_func, (Notify_client nclient, Notify_io_func func, int fd));
EXTERN_FUNCTION (Notify_error 	notify_interpose_signal_func, (Notify_client nclient, Notify_signal_func func, int signal, Notify_signal_mode mode));
...
EXTERN_FUNCTION (Notify_error 	notify_remove_destroy_func, (Notify_client nclient, Notify_destroy_func func));
EXTERN_FUNCTION (Notify_error 	notify_remove_event_func, (Notify_client nclient, Notify_event_interposer_func func, Notify_event_type when));
EXTERN_FUNCTION (Notify_error 	notify_remove_exception_func, (Notify_client nclient, Notify_io_func func, int fd));
EXTERN_FUNCTION (Notify_error	notify_remove_input_func, (Notify_client nclient, Notify_io_func func, int fd));
EXTERN_FUNCTION (Notify_error 	notify_remove_itimer_func, (Notify_client nclient, Notify_timer_func func, int which));
EXTERN_FUNCTION (Notify_error	notify_remove_output_func, (Notify_client nclient, Notify_io_func func, int fd));
EXTERN_FUNCTION (Notify_error 	notify_remove_signal_func, (Notify_client nclient, Notify_signal_func func, int signal, Notify_signal_mode mode));
...
#endif
EXTERN_FUNCTION (Notify_prioritizer_func notify_set_prioritizer_func, (Notify_client nclient, Notify_prioritizer_func func));
EXTERN_FUNCTION (Notify_scheduler_func notify_set_scheduler_func, (Notify_scheduler_func func));
