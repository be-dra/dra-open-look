#ifndef	lint
#ifdef sccs
static char     sccsid[] = "@(#)ntfyclient.c 20.18 93/06/28 Copyr 1985 Sun Micro  DRA: $Id: ntfyclient_notfind.c,v 4.1 2024/03/28 18:09:08 dra Exp $ ";
#endif
#endif
...
/* DRA_CHANGED: after SuSE 6.2, I encountered many obscure
 * Notifier error: unknown client
 * Therefore, I tried without tsearch: MUCH BETTER
 */
/* #define HAVE_TSEARCH */
