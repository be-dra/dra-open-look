#ifndef	lint
#ifdef sccs
static char     sccsid[] = "@(#)ntfy_debug.c 20.20 93/06/28 Copyr 1985 Sun Micro  DRA: $Id: ntfy_debug.c,v 4.2 2024/03/28 18:17:36 dra Exp $ ";
#endif
#endif
...
pkg_private void
ntfy_set_errno_debug(Notify_error  error)
{
    notify_errno = error;
...
pkg_private void
ntfy_set_warning_debug(Notify_error error)
{
    notify_errno = error;
...
pkg_private void
ntfy_fatal_error(const char *msg)
{
    char	   *error_string;
