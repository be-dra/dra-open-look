/*      @(#)xv_debug.h 20.14 93/06/28 SMI   DRA: $Id: xv_debug.h,v 4.2 2024/11/30 12:36:36 dra Exp $      */
...
Xv_private void	(*xv_abort)(void);
Xv_private void	(*xv_dprintf)(FILE *file, char *fmt, ...);
Xv_private int	(*xv_take_breakpoint)(void);
