/*	@(#)draw_impl.h 20.33 93/06/28 SMI   DRA: $Id: draw_impl.h,v 4.2 2024/05/25 18:33:06 dra Exp $	*/
...
extern GC xv_private_gc(Xv_opaque);
extern Xv_Drawable_info	*drawable_info(void);
/* drawable.c */
