#ifndef lint
#ifdef sccs
static char     sccsid[] = "@(#)xv_debug.c 20.18 93/06/28  DRA: $Id: xv_debug.c,v 4.2 2024/09/15 08:15:21 dra Exp $";
#endif
#endif
...
void            (*xv_abort) (void) = _xview_abort;
void            (*xv_dprintf) () = _xview_dprintf;
int             (*xv_take_breakpoint) (void) = _xview_take_breakpoint;
