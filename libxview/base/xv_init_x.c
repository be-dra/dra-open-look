#ifndef lint
#ifdef sccs
static char     sccsid[] = "@(#)xv_init_x.c 20.27 93/06/28  DRA: $Id: xv_init_x.c,v 4.1 2024/03/28 19:35:11 dra Exp $";
#endif
#endif
...
extern XErrorHandler xv_x_error_proc;
extern XErrorHandler xv_xlib_error_proc;


Xv_private void xv_set_default_font(Display *display, int screen, Font font)
{
...
Xv_private int xv_x_error_handler(Display *dpy, XErrorEvent *event)
{
	int result;
	...
	if (xv_xlib_error_proc)
		...
		xv_error(XV_NULL,
				ERROR_SERVER, event,
				ERROR_SEVERITY, ERROR_NON_RECOVERABLE, NULL);
