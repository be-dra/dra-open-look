...
#define XV_ALIST(_t_, _o_) XV_ATTR(ATTR_LIST_INLINE(ATTR_NULL, _t_), _o_)
...
_XVFUNCPROTOBEGIN
EXTERN_FUNCTION (Xv_object xv_init, (Attr_attribute attr1, DOTDOTDOT)) _X_SENTINEL(0);
EXTERN_FUNCTION (Attr_attribute xv_unique_key, (void));
EXTERN_FUNCTION (void xv_usage, (char *name));
_XVFUNCPROTOEND
