#ifndef lint
#ifdef sccs
static char     sccsid[] = "@(#)fm_bdry.c 20.22 93/06/28 DRA: $Id: fm_bdry.c,v 4.1 2024/03/28 12:57:19 dra Exp $ ";
#endif
#endif
...
static void compute_shadows(Frame_class_info *frame, Xv_Window target_sw, Rect *left_shadow, Rect *right_shadow, Rect *top_shadow, Rect *bottom_shadow);
