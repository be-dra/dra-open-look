#ifndef lint
#ifdef sccs
static char     sccsid[] = "@(#)frame_cmd.c 1.48 93/06/28 DRA: $Id: frame_cmd.c,v 4.7 2026/04/17 12:00:04 dra Exp $ ";
#endif
#endif
...
static Notify_value frame_cmd_input(Frame frame_public, Notify_event ev,
...
static Xv_opaque frame_cmd_set_avlist(Frame frame_public,
...
static Xv_opaque frame_cmd_get_attr(Frame frame_public, int *status,
...
static int frame_cmd_destroy(Frame frame_public, Destroy_status status)
{
    Frame_cmd_info *frame = FRAME_CMD_PRIVATE(frame_public);
