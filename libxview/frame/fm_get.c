#ifndef lint
#ifdef sccs
static char     sccsid[] = "@(#)fm_get.c 20.62 93/06/28 DRA: $Id: fm_get.c,v 4.2 2024/09/15 07:41:59 dra Exp $ ";
#endif
#endif
 ...
 */
Pkg_private Frame_menu_accelerator *frame_find_menu_acc(Frame frame_public,
