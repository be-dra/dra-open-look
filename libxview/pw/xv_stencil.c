#ifndef lint
#ifdef sccs
static char     sccsid[] = "@(#)xv_stencil.c 20.24 89/07/31 DRA: RCS $Id: xv_stencil.c,v 2.1 2020/07/26 07:31:25 dra Exp $";
#endif
#endif
 ...
 */
/* ARGSUSED */
Xv_private int xv_stencil_internal(Display *display, Xv_Drawable_info *info,
		Drawable d, GC gc,
