/*	@(#)pixwin.h 20.30 93/06/28 SMI  DRA: RCS $Id: pixwin.h,v 2.3 2024/12/29 18:04:15 dra Exp $	*/
...
EXTERN_FUNCTION (int xv_replrop, (Xv_opaque window, int xw, int yw, int width, int height, int op, Pixrect *pr, int xr, int yr)); 
EXTERN_FUNCTION (int xv_rop, (Xv_opaque window, int x, int y, int width, int height, int op, Pixrect *pr, int xr, int yr));
...
struct pr_trap trap, int op, struct pixrect *spr, int sx, int sy ) );
_XVFUNCPROTOBEGIN
