#ifndef lint
#ifdef sccs
static char     sccsid[] = "@(#)cms.c 1.17 91/03/18 DRA: RCS $Id: cms.c,v 2.2 2020/12/27 08:37:11 dra Exp $";
#endif
#endif
 ...
 */
Pkg_private int cms_get_colors(Cms_info *cms, unsigned long cms_index,
