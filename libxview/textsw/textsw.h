/*	@(#)textsw.h 20.56 93/06/28 SMI  DRA: $Id: textsw.h,v 4.10 2025/02/25 17:00:15 dra Exp $	*/
...
typedef enum {
	...
	TEXTSW_CONVERT_PROC		= TEXTSW_ATTR(ATTR_FUNCTION_PTR, 69),
	...
	TEXTSW_IS_TERMSW			= TEXTSW_ATTR(ATTR_BOOLEAN, 117),
...
EXTERN_FUNCTION (void textsw_file_lines_visible, (Textsw_view view, int *top, int *bottom));
...
EXTERN_FUNCTION (Textsw_index textsw_replace, (Textsw textsw, Textsw_index first, Textsw_index last_plus_one, char *buf, long int buf_len));
...
EXTERN_FUNCTION (int textsw_screen_line_count, (Textsw_view v));

EXTERN_FUNCTION (void textsw_scroll_lines, (Textsw_view v, int count));
...
EXTERN_FUNCTION (void textsw_set_backup_pattern, (Textsw textsw, const char *pattern));
