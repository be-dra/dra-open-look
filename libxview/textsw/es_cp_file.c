#ifndef lint
char     es_cp_file_c_sccsid[] = "@(#)es_cp_file.c 20.33 93/06/28 DRA: $Id: es_cp_file.c,v 4.2 2024/09/15 16:22:28 dra Exp $";
#endif
...
#define	es_Perror(s)
#ifdef OW_I18N
Pkg_private int es_copy_fd(from_wc, to_wc, fold)
    CHAR           *from_wc, *to_wc;
    int             fold;
#else
...
#endif
{
    ...
    char           *last, destname[BSIZE], buf[BSIZE];
		     ...
		     */
    char            *last, destname[2*MAXNAMLEN], buf[BSIZE];
