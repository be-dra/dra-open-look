 ...
 */
#ifndef	lint
#define UNUSED_attr_replace_cu(avlist, font, lmargin, tmargin, rgap) 	\
...
#define UNUSED_attr_cu_to_x(encoded_value, font, left_margin) 		\
    attr_rc_unit_to_x(encoded_value, xv_get(font, FONT_DEFAULT_CHAR_WIDTH), left_margin, 0)

#define UNUSED_attr_cu_to_y(encoded_value, font, top_margin, row_gap) 	\
 ...
 */
typedef unsigned long	 Attr_attribute;	/* 32/64 bit quantity */
 ...
 * Public Functions
 */
EXTERN_FUNCTION (Attr_avlist attr_create_list, (Attr_attribute attr1, DOTDOTDOT)) _X_SENTINEL(0);
