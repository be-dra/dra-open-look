...
#define window_fit(win) \
   (void)xv_set(win, WIN_FIT_HEIGHT, 0, WIN_FIT_WIDTH, 0, NULL)

#define window_fit_height(win) \
   (void)xv_set(win, WIN_FIT_HEIGHT, 0, NULL)

#define window_fit_width(win) \
   (void)xv_set(win, WIN_FIT_WIDTH, 0, NULL)
...
typedef int (*window_layout_proc_t)(Xv_Window, Xv_Window, Window_layout_op, Xv_opaque, Xv_opaque, Xv_opaque, Xv_opaque, Xv_opaque);
