#ifndef lint
#ifdef sccs
static char     sccsid[] = "@(#)site.c 1.13 93/06/28 DRA: $Id: site.c,v 4.1 2024/03/28 13:07:32 dra Exp $ ";
#endif
#endif
...
Pkg_private Xv_opaque DndDropAreaOps(Dnd_site_info	*site, Dnd_region_ops mode, Xv_opaque area)
{
    switch(mode) {
      case Dnd_Add_Window: {
	  ...
	  windows = xv_alloc_n(Xv_Window, (size_t)(site->num_regions + 1) );
