...
EXTERN_FUNCTION (Xv_opaque dnd_decode_drop, (Selection_requestor object,
												Event *event));
EXTERN_FUNCTION (void dnd_done, (Selection_requestor sel));

EXTERN_FUNCTION (void dnd_preview_reply, (Event *ev, int reject));
EXTERN_FUNCTION (void dnd_reject_unless, (Event *ev, Atom first, DOTDOTDOT)) _X_SENTINEL(0);
