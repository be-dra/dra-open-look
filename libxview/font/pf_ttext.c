#ifndef lint
#ifdef sccs
static char     sccsid[] = "@(#)pf_ttext.c 20.15 93/06/28 SMI DRA: RCS $Id: pf_ttext.c,v 4.1 2024/03/28 17:55:25 dra Exp $ ";
#endif
#endif
...
Xv_public int xv_pf_ttext(struct pr_prpos prpos, int op, Pixfont *pf, char *str);
