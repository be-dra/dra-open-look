#ifndef lint
char str_utils_c_sccsid[] = "@(#)str_utils.c 20.15 93/06/28 RCS: $Id: str_utils.c,v 4.3 2024/09/15 16:11:29 dra Exp $";
#endif
    ...
    struct CharAction (*charproc) ();
{
	...
	if (c == '\0')
	    goto backup;
	{
		typedef struct CharAction (*mychproc_t)( int);
    	mychproc_t mycharproc = (mychproc_t)charproc;
