#ifndef lint
#ifdef sccs
static char     sccsid[] = "@(#)xv_path_util.c 1.6 93/06/29  DRA: RCS $Id: xv_path_util.c,v 4.1 2024/03/28 13:04:11 dra Exp $ ";
#endif
#endif
...
Pkg_private char *xv_strcpy(char *dest, char *src)
{
	...
	if (new) {
		...
		xv_error(XV_NULL,
				...
				ERROR_STRING, XV_MSG("out of memory, copying string!"), NULL);
	}
	return dest;
}
