...
#else
static void DrawString(Xv_Window win, unsigned long frg_pixel, unsigned long bkg_pixel, int x, int y, Xv_opaque pixfont, char *str);
#endif
...
Xv_private void icon_display(Icon icon_public, int x, int y)
{
