...
#define MENU_MIXED_MENU			&xv_mixed_menu_pkg
...
typedef enum {
	...
	MENU_DISABLE_ITEM	= MENU_ATTR(ATTR_ENUM,			 30),  /*NYI*/
	MENU_DONE_PROC		= MENU_ATTR(ATTR_FUNCTION_PTR,	31),
	MENU_FEEDBACK		= MENU_ATTR(ATTR_BOOLEAN,		 33), 
	MENU_FIRST_EVENT	= MENU_ATTR(ATTR_NO_VALUE,		 36), /*--G*/	
	...
	MENU_LAST_EVENT		= MENU_ATTR(ATTR_NO_VALUE,		 99), /*--G*/	
	/*
	...
	MENU_NITEMS		= MENU_ATTR(ATTR_NO_VALUE,		108), /*--G*/	
	...
	MENU_TYPE		= MENU_ATTR(ATTR_NO_VALUE,		183), /*--G*/	
	...
	MENU_STRINGS_AND_ACCELERATORS=MENU_ATTR_LIST(ATTR_NULL,ATTR_OPAQUE_PAIR,246),
        /* ACC_XVIEW */

	MENU_PREVIEW_PROC	= MENU_ATTR(ATTR_FUNCTION_PTR,	32),
	/*
	 * Private Attributes 
	 */
...
EXTERN_FUNCTION (void menu_show, (Menu menu, Xv_Window win, Event *event, DOTDOTDOT)) _X_SENTINEL(0);
...
EXTERN_FUNCTION (Menu menu_create, (Attr_attribute attr1, DOTDOTDOT)) _X_SENTINEL(0);
EXTERN_FUNCTION (Menu_item menu_create_item, (Attr_attribute attr1, DOTDOTDOT)) _X_SENTINEL(0);
EXTERN_FUNCTION (Menu_item 	menu_find, (Menu menu, DOTDOTDOT)) _X_SENTINEL(0);
EXTERN_FUNCTION (Xv_opaque 	menu_get, (Menu menu, Xv_opaque attr, Xv_opaque v1));
EXTERN_FUNCTION (Xv_opaque 	menu_set, (Menu menu, DOTDOTDOT)) _X_SENTINEL(0);
EXTERN_FUNCTION (void menu_destroy_with_proc, (Menu menu, void (*proc)(void)));
_XVFUNCPROTOEND
