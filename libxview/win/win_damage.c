#ifndef lint
#ifdef sccs
static char     sccsid[] = "@(#)win_damage.c% 20.35 93/06/28 DRA: $Id: win_damage.c,v 4.2 2024/10/25 15:04:38 dra Exp $";
#endif
#endif
...
static int win_do_expose_event_predicate(Display *display, XEvent *event,
									char *args)
{
	XExposeEvent *e;
