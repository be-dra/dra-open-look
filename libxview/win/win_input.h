...
/* 
 * ACTION_SET_DIRECTORY and ACTION_GET_FILENAME appeared unused
 * therefore we use it for mouse wheel support
 */
#define ACTION_WHEEL_FORWARD            ACTION_SET_DIRECTORY 
#define ACTION_WHEEL_BACKWARD           ACTION_GET_FILENAME 
...
#define ACTION_PASTE_PRIMARY	(XVIEW_FIRST+133)   /* 31877 */

#define XVIEW_LAST ACTION_PASTE_PRIMARY   /* 31877 */
...
_XVFUNCPROTOBEGIN
EXTERN_FUNCTION (int win_set_kbd_focus, (Xv_object window, XID xid));
...
extern int win_set_clip(Xv_object window, Rectlist *rl);

/* implemented in bvase/xv_init.c */
EXTERN_FUNCTION (int xv_translate_iso, (Event *ev));
