/*	@(#)win_keymap.h 20.12 93/06/28 SMI  DRA: $Id: win_keymap.h,v 4.1 2024/03/28 19:28:19 dra Exp $	*/
...
Xv_private void win_keymap_set_smask_class(Xv_object win, Event_class class);
