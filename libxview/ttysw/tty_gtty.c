...
/* martin.buck@bigfoot.com */
        0,                                     /* line discipline */
	/* komisch das hat gefehlt und man hat nix gemerkt ??? */
	{
...
static int we_getptyparms(struct termios *tp);
/*
