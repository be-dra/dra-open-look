 ...
 * For Sunview 1 compatibility 
 */
EXTERN_FUNCTION (Xv_Cursor cursor_create, (Attr_attribute attr1, DOTDOTDOT)) _X_SENTINEL(0);
...
EXTERN_FUNCTION (int		cursor_set, (Xv_Cursor cursor, DOTDOTDOT)) _X_SENTINEL(0);
_XVFUNCPROTOEND
