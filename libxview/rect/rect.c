#ifndef lint
#ifdef sccs
static char     sccsid[] = "@(#)rect.c 20.17 93/06/28 Copyr 1984 Sun Micro DRA: $Id: rect.c,v 4.2 2024/05/23 15:15:47 dra Exp $";
#endif
#endif
 ...
 */
void rect_intersection(struct rect *r1, struct rect *r2, struct rect *r)
{
...
{	   /* Return true if r1 & r2 are in the
	...
	switch (sortorder) {
		...
		default:
			xv_error(XV_NULL,
					ERROR_STRING, XV_MSG("Bad sortorder arg in mostRect"),
					NULL);
			break;
	}
	return (FALSE);
