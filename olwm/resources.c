...
static Bool matchUiStyle(char *str, UiStyles *ret)
{
	if (0 == strcmp(str, "two_d_bw")) {
		*ret = UIS_2D_BW;
		return True;
	}
	else if (0 == strcmp(str, "two_d_color")) {
		*ret = UIS_2D_COLOR;
		return True;
	}
	else if (0 == strcmp(str, "three_d_color")) {
		*ret = UIS_3D_COLOR;
		return True;
	}
	return False;
...
static Bool cvtUiStyle(Display *dpy, ResourceItem *item, char *string, void *addr)
{
    return matchUiStyle(string, (UiStyles *)addr);
}

static void updUiStyle(Display *dpy, ResourceItem *item, UiStyles *cur, UiStyles *new)
{
    if (*cur != *new) {
		*cur = *new;
    }
...
{   "iconLocation",		"IconLocation", 	"bottom",
    ...
    0L },
{   "gridSpacing",		"GridSpacing",	"13",
    &(GRV.GridSpacing),	cvtInteger,		NULL,
    0L },
...
{   "autoRaiseDelay",		"AutoRaiseDelay",	"0",
    ...
    0L },
{   "dragRightDistance",	"DragRightDistance",	"20",
...
{   "textDelimiterChars",		"TextDelimiterChars",	
	" \t,.:;?!\'\"`*/-+=(){}[]<>\\|~@#$%^&",
    &(GRV.TextDelimiterChars),	cvtString,		NULL,
    0L },
...
{   "colorFocusLocked",		"ColorFocusLocked",	"False",
    ...
    0L },
{   "edgeMoveThreshold",	"EdgeMoveThreshold", 	"50",
...
{   "minimalDecor",		"MinimalDecor",		"",
    ...
    0L },
{   "ignoreMinMaxSizes",		"IgnoreMinMaxSizes",		"",
    &(GRV.IgnoreMinMax),		cvtStringList,		updStringList,
    0L },
...
{   "invertFocusHighlighting",	"InvertFocusHighlighting", "False",
    ...
    0L },
{
	"runSlaveProcess",		"RunSlaveProcess",
	/* we start it 'on demand' */
	"False",
...
{   "flashCount",		"FlashCount",		"6",
    ...
    0L },
{   "maximumIconSize",		"MaximumIconSize",		"160",
    &(GRV.MaximumIconSize),		cvtInteger,		NULL,
    0L },
...
{   "menuClickExecutesDefault",		"MenuClickExecutesDefault",	"False",
    ...
    0L },
{   "pureOpenLookWindowMenus",		"PureOpenLookWindowMenus",	"True",
    &(GRV.pureOpenLookWindowMenus),	cvtBoolean,		NULL,
    0L },
{   "screenSizeRestrictsWindowSize", "ScreenSizeRestrictsWindowSize", "True",
    &(GRV.screenSizeRestrictsWindowSize),	cvtBoolean,		NULL,
    0L },
{	"uiStyle",		"UiStyle",	"three_d_color",
    &(GRV.ui_style),	cvtUiStyle,		updUiStyle,
    0L },
