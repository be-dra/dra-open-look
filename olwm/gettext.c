    ...
    char	*domain_name;
{
    ...
    current_locale = DRA_CHANGED_setlocale(LC_MESSAGES, NULL);
...
char *
olwm_dra_obsolete_bindtextdomain(domain_name, binding)
    char    *domain_name;
...
char *
olwm_dra_obsolete_textdomain(domain_name)
    char    *domain_name;
{
...
char *
olwm_dra_obsolete_dgettext(domain_name, msg_id)
    char    *domain_name;
    char    *msg_id;
{
...
char *
olwm_dra_obsolete_gettext(msg_id)
char *msg_id;
{
    return (olwm_dra_obsolete_dgettext(NULL, msg_id));
}
