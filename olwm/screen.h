/* @(#) %M% V%I% %E% %U% $Id: screen.h,v 2.2 2025/01/11 20:13:01 dra Exp $ */
...
struct _quick_dupl;
struct _winpaneframe;
struct _wingenericframe;
extern int dra_quick_handle_selection(Display *dpy, XEvent *xev,
									struct _winpaneframe *frameInfo);
extern Bool dra_quick_duplicate_start(Display *dpy, XEvent *event,
									struct _wingenericframe *frameInfo);
extern Bool dra_quick_duplicate_update(Display *dpy, XEvent *event,
									struct _wingenericframe *frameInfo);
